...
async function _buildAnalysisHTML() {
    ...
    const itemCount = _filteredAnnotations().length;
...
function renderAnalysisDashboard() {
    ...
    container.innerHTML = `
        ...
        <div class="analysis-grid">
            ...
            <div class="analysis-card analysis-card-wide">${_chartAnnotationsOverTime(items)}</div>
            <div class="analysis-card analysis-card-wide" id="wf-card">${_chartWordFrequency(items)}</div>
            <div class="analysis-card analysis-card-wide">${_chartCoOccurrence(items)}</div>
            <div class="analysis-card analysis-card-wide">${_chartDocumentMatrix(items)}</div>
            <div class="analysis-card analysis-card-wide">${_chartCodingDensity(items)}</div>
            <div class="analysis-card analysis-card-wide" id="analysis-network-card">${_chartThemeNetwork(items)}</div>
            <div class="analysis-card analysis-card-wide">${_chartKWIC()}</div>
            <div class="analysis-card analysis-card-wide">${_chartSaturation(items)}</div>
            <div class="analysis-card analysis-card-wide">${_chartSentiment(items)}</div>
            <div class="analysis-card analysis-card-wide">${_chartTFIDF(items)}</div>
            <div class="analysis-card analysis-card-wide">${_chartIRR()}</div>
        </div>`;
    refreshIcons(container);
...
function _chartDocumentMatrix(items, options = {}) {
    ...
    const exportBtnMatrix = options.project ? `<div class="analysis-export-actions">
...
function _chartSaturation(items, options = {}) {
    ...
    const exportActions = options.project ? `
            <div class="analysis-export-actions">
...
function _chartSentiment(items, options = {}) {
    ...
    const segs = [{ label: 'Positive', count: pos, color: '#22c55e' }, { label: 'Neutral', count: neu, color: '#94a3b8' }, { label: 'Negative', count: neg, color: '#ef4444' }].filter(s => s.count > 0);
    let off = 0;
    ...
    return `
        <div class="analysis-card-header"><span>${icon('smile')} Annotation Sentiment</span><small>${sourceNote}</small>${exportBtnSentiment}</div>
...
function _chartTFIDF(items, options = {}) {
    ...
    const exportBtnTFIDF = options.project ? `<div class="analysis-export-actions">
