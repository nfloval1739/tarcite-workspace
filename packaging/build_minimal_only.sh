...
CODESIGN_IDENTITY="Developer ID Application: PT. DIGITAL ENGINERING INDONESIA (8XBP4MRL6L)"
...
echo "  xcrun notarytool submit $MINIMAL_DMG --apple-id \$APPLE_ID --team-id 8XBP4MRL6L --password \$APPLE_APP_PASSWORD --wait"
