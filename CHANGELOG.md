...
- **PDF reading & annotation** — highlight, ink/freehand, and tag annotations with a tag
  hierarchy.
- **Reference management** — Zotero and Mendeley import, folder organization, and citation
...
[Unreleased]: https://github.com/nfloval1739/tarcite-workspace/compare/v0.2.26...HEAD
