...
# Bundled Ollama binary (run packaging/download_ollama.sh / .bat first)
# Platform-specific folders keep macOS and Windows builds from cross-contaminating
...
# Pre-pulled Ollama model blobs (run packaging/download_ollama.sh / .bat first)
